...
def stacked_barplot_relative_abundance(resulting_df, top_x = 15, sample_names = [" "], plot_column =" ", title =" ", title_label = " ", saveToFile = True, output_dir ="./", figsize = [15, 10]):
    """
    ...
    :param sample_names: List of names for each sample. Default is empty list.
