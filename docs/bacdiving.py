...
def bacdive_call(bacdive_id ="", bacdive_password ="", input_lists = {}, sample_names = [], print_res_df_ToFile = 1, print_access_stats = 1, output_dir ="./"):
    """
    For multiple input files this function reads the input, queries the BacDive database and stores resulting dataframe(s) and access statistics.
